...
<style>
    ...
    /* ✅ TAMBAHAN: supaya teks/password tidak masuk ke area tombol mata */
    .input-has-toggle {
        padding-right: 46px !important;
    }

    /* ✅ TAMBAHAN: matikan icon "reveal password" bawaan browser (penyebab double icon) */
    ...
    <div class="container-custom" id="container">
        ...
        <div class="form-container sign-up-container">
            <form action="{{ route('register.post') }}" method="POST">
                ...
                <div class="in-field">
                    ...
                    <input type="password" name="password" id="reg-pass" class="input-has-toggle" placeholder="Password" required />
                    <i class="fa-solid fa-eye toggle-password" onclick="togglePass('reg-pass', this)"></i>
                </div>

                <div class="in-field">
                    <i class="fa-solid fa-lock"></i>
                    <input type="password" name="password_confirmation" id="reg-conf-pass" class="input-has-toggle" placeholder="Konfirmasi Password" required />
        ...
        <div class="form-container sign-in-container">
            <form action="{{ route('login.post') }}" method="POST">
                ...
                <div class="in-field">
                    <i class="fa-solid fa-lock"></i>
                    <input type="password" name="password" id="login-pass" class="input-has-toggle" placeholder="Password" required />
